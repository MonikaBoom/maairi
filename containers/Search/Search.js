...
class Index extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            submitting: false,
            countries:props.pageInfoData.countries,
            languages:props.pageInfoData.spokenLanguage,
            ...
            fields: {
                ...
                country:props.pageInfoData && props.pageInfoData.country ? props.pageInfoData.country : "",
                language:props.pageInfoData && props.pageInfoData.language ? props.pageInfoData.language : "",
            },
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if(prevState.localUpdate){
            ...
            return { 
                countries:nextProps.pageInfoData.countries,
                languages:nextProps.pageInfoData.spokenLanguage,
                categories:nextProps.pageInfoData.categories ? nextProps.pageInfoData.categories : nextProps.categories,
                submitting: false,
                showForm:false, 
    ...
    render() {
        ...
        for (var key in sort) {
            ...
            } else if (key == "favourite" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_favourite'] == 1) {
                sortArray.push({ key: key, value: sort[key] })
            } else if (key == "view") {
                sortArray.push({ key: key, value: sort[key] })
            } else if (key == "like" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_like'] == "1") {
                sortArray.push({ key: key, value: sort[key] })
            } else if (key == "dislike" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_dislike'] == "1") {
                sortArray.push({ key: key, value: sort[key] })
            } else if (key == "rated" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_rating'] == "1") {
                sortArray.push({ key: key, value: sort[key] })
            } else if (key == "comment" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_comment'] == "1") {
                sortArray.push({ key: key, value: sort[key] })
            }
        }
        const typeArray = []
        for (var key in filter) {
            if (key == "featured" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_featured'] == 1) {
                typeArray.push({ key: key, value: filter[key] })
            } else if (key == "sponsored" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_sponsored'] == 1) {
                typeArray.push({ key: key, value: filter[key] })
            } else if (key == "hot" && this.props.pageInfoData.appSettings[(this.state.subtype ? this.state.subtype + "_" : "") + type + '_hot'] == 1) {
                typeArray.push({ key: key, value: filter[key] })
                                ...
                                <React.Fragment>
                                    ...
                                    }
                                    {
                                        this.state.submitting ?
                                            ...
                                            <Movie {...this.props} typeData={this.state.type} search={this.state.fields} pageData={{ movies: this.state.items, pagging: this.state.pagging }} globalSearch={true} />
                                            :
                                            this.state.items ?
