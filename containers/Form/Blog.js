...
class Blog extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      initialState: props.pageInfoData.editItem ? props.pageInfoData.editItem.description : "",
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if(prevState.localUpdate){
        ...
        return {
          ...
          initialState: nextProps.pageInfoData.editItem ? nextProps.pageInfoData.editItem.description : "",
...
componentDidUpdate(prevProps,prevState){
  ...
  render() {
    ...
    return (
      <React.Fragment>
          <Breadcrum {...this.props}  image={this.props.pageData['pageInfo']['banner'] ? this.props.pageData['pageInfo']['banner'] : this.props.pageInfoData['subFolder']+"static/images/breadcumb-bg.jpg"}title={`${this.state.editItem ? "Edit" : "Create"} Blog`} />          
