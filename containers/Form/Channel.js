        ...
        return (
            <React.Fragment>
                { this.state.openPopup ?  <AddVideos {...this.props} chooseVideos={this.chooseVideos} closePopup={this.closePopup} title={Translate(this.props,"Add video to channel")} /> :null }
                    <Breadcrum {...this.props}  image={this.props.pageData['pageInfo']['banner'] ? this.props.pageData['pageInfo']['banner'] : this.props.pageInfoData['subFolder']+"static/images/breadcumb-bg.jpg"} title={`${this.state.editItem ? "Edit" : "Create"} Channel`} />          
