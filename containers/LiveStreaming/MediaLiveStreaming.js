...
class Index extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            iframeSRC:"",
            hide:false,
            banners:  props.pageInfoData.banners ? props.pageInfoData.banners : [],
            backgroundColor: props.pageInfoData.brands && props.pageInfoData.brands.background_color ? props.pageInfoData.brands.background_color : "#000000",
            textColor: props.pageInfoData.brands && props.pageInfoData.brands.text_color ? props.pageInfoData.brands.text_color : "#ffffff",
            brands:props.pageInfoData.brands ? props.pageInfoData.brands : {},
            isChecked:false,
            showAddBtn:false
        }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if(prevState.localUpdate){
            ...
            return {
                banners:nextProps.pageInfoData.banners ? nextProps.pageInfoData.banners : [],
                showAddBtn:false,
                editBanner:0,
                backgroundColor: nextProps.pageInfoData.brands && nextProps.pageInfoData.brands.background_color ? nextProps.pageInfoData.brands.background_color : "#000000",
                textColor: nextProps.pageInfoData.brands && nextProps.pageInfoData.brands.text_color ? nextProps.pageInfoData.brands.text_color : "#ffffff",
                brands:nextProps.pageInfoData.brands ? nextProps.pageInfoData.brands : {},
    ...
    componentDidMount(){
        ...
        this.props.socket.on('bannerData', data => {
            let owner_id = this.state.video ? this.state.video.owner_id : this.props.pageInfoData.loggedInUserDetails.user_id
        ...
        if(this.state.role == "host"){
            this.props.socket.on('hideBannerLive', data => {
                ...
                if (this.props.pageInfoData.loggedInUserDetails && this.props.pageInfoData.loggedInUserDetails.user_id == user_id && itemIndex > -1) {
            ...
            this.props.socket.on('newBannerLive', data => {
                ...
                let user_id = data.user_id;
                if (this.props.pageInfoData.loggedInUserDetails && this.props.pageInfoData.loggedInUserDetails.user_id == user_id) {
                    let banners = [...this.state.banners]
                    let banner = {}
                    banner.text = text
                    banner.show = show
        ...
        this.props.socket.on('updateBrandLive', data => {
            if (this.props.pageInfoData.loggedInUserDetails && this.props.pageInfoData.loggedInUserDetails.user_id == data.user_id) {
    ...
    iframeLoaded = () => {
        ...
        var websocketURL =  "ws://" + path+`:5080/${this.props.pageInfoData.streamingAppName}/websocket?rtmpForward=`;
        if (orgName.startsWith("https")) {
            websocketURL = "wss://" + path+`:5443/${this.props.pageInfoData.streamingAppName}/websocket?rtmpForward=`;
        } 
        ...
        values['appName'] = this.props.pageInfoData.streamingAppName;
        if(parseInt(this.props.pageInfoData.appSettings['antserver_media_hlssupported']) == 1)
        values['playOrder'] = parseInt(this.props.pageInfoData.appSettings['antserver_media_hlssupported']) == 1 ? "hls,webrtc" : "webrtc,hls";
    ...
    render(){
        ...
        return (
            ...
            <div className="videoSection2">
                ...
                {
                    this.state.allow_chat == 1 && this.props.pageInfoData.levelPermissions["livestreaming.branding_livestreaming"] != 1 ?  
                                                ...
                                                <div className="lsLogoOptions">
                                                    
                                                    {
                                                        this.state.brands.logo ? 
                                                            <div className={`lsLogoOptions-box${this.state.brands.logo_active == 1 ? " active" : ""}`}>
                                                                <img src={this.props.pageInfoData.imageSuffix+this.state.brands.logo} className="img-fluid" onClick={(e) => {
                                                                    let brand = {...this.state.brands}
                                                    ...
                                                    :
                                                            <div className="lsLogoOptions-box addlogobtn" onClick={(e) => {
                                                                ...
                                                                <input type="file" ref={this.inputFileLogo} onChange={(e) => {
                                                    ...
                                                    <div className="lsLogoOptions">
                                                        {
                                                            ...
                                                            <div className={`lsLogoOptions-box${this.state.brands.overlay_active == 1 ? " active" : ""}`}>
                                                                <img src={this.props.pageInfoData.imageSuffix+this.state.brands.overlay} className="img-fluid" onClick={(e) => {
                                                                    let brand = {...this.state.brands}
                                                        ...
                                                        :
                                                            <div className="lsLogoOptions-box addlogobtn" onClick={(e) => {
                                                                ...
                                                                <input type="file" ref={this.inputFileOverlay} onChange={(e) => {
