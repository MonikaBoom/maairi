...
class FixedMenu extends Component {
    ...
    render() {
        ...
        return (
            <header id="header" className={`${!this.props.pageInfoData.removeFixedMenu ? "fixed-top" : "nofixed-top"}`}>
                                    ...
                                    <ul className="loggedin">
                                        ...
                                        { 
                                            this.props.pageInfoData.loggedInUserDetails ?
                                                <React.Fragment>
                                                    { 
                                                        this.props.pageInfoData.levelPermissions && parseInt(this.props.pageInfoData.levelPermissions["member.allow_messages"]) == 1 ? 
