...
class Index extends React.Component {
    ...
    render() {       
        ...
        const moviesEnable = this.props.pageInfoData.appSettings['enable_movie']
            ...
            <React.Fragment>
                {gatewaysHTML}
                    <div className="titleBarTop">
                        <div className="titleBarTopBg"><img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageInfoData['subFolder']+"static/images/breadcumb-bg.jpg"}
                                        ...
                                        <tbody>
                                            ...
                                            <React.Fragment>
                                            {
                                                moviesEnable == 1 ?
                                                    <tr>
                                                        <td className="pricing-heading">
                                                            {this.props.t("Create Movies & Series")}
                                                        </td>
                                                        {
                                                            this.state.packages.map(result => {
                                                                return <td key={result.package_id}>
                                                                       {
                                                                           result.create_movies != 1 ? 
                                                                            <span className="notick"><span className="material-icons" data-icon="close"></span></span>
                                                                           :
                                                                        result.movies_create_limit != 0 ? `${this.props.t("Create {{limit}} movie(s)/series",{limit:result.movies_create_limit})}` : this.props.t("Unlimited")
                                                                       }
