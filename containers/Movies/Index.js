...
import MediaElementPlayer from "../Video/MediaElementPlayer"

class Movie extends React.Component{
    constructor(props){
        super(props)
        let seasonCurrentIndex = props.pageInfoData.seasonCurrentIndex ? props.pageInfoData.seasonCurrentIndex : 0
        this.state = {
            styles: {
                visibility: "hidden",
                overflow: "hidden"
            ...
            collapse: true,
            trailer:props.pageInfoData.trailer,
            contentType:props.pageData.contentType,
            movie:props.pageInfoData.movie,
            seasons:props.pageInfoData.seasons,
            clipsTrailers:props.pageInfoData.clipsTrailers,
            needSubscription:props.pageInfoData.needSubscription,
            plans:props.pageInfoData.plans,
            tabType:props.pageInfoData.tabType ? props.pageInfoData.tabType : "episodes",
            relatedMovies:props.pageInfoData.relatedMovies,
            movie_countries:props.pageInfoData.movie ? props.pageInfoData.movie.movie_countries : null,
            generes:props.pageInfoData.movie ? props.pageInfoData.movie.generes : null,
            castncrew:props.pageInfoData.movie ? props.pageInfoData.movie.castncrew : null,
            images:props.pageInfoData.movie ? props.pageInfoData.movie.images : null,
            adult: props.pageInfoData.adultMovie,
            password: props.pageInfoData.password,
            episode:props.pageInfoData.episode,
            adminAdVideo:props.pageInfoData.adminAdVideo,
            userAdVideo:props.pageInfoData.userAdVideo,
            reviews:props.pageInfoData.reviews ? props.pageInfoData.reviews : null,
            episodes: props.pageInfoData.episodes ? props.pageInfoData.episodes : (props.pageInfoData.seasons && props.pageInfoData.seasons[seasonCurrentIndex].episodes ? props.pageInfoData.seasons[seasonCurrentIndex].episodes : null),
            episode_season: props.pageInfoData.episode_season ? props.pageInfoData.episode_season : (props.pageInfoData.seasons && props.pageInfoData.seasons[seasonCurrentIndex] ? props.pageInfoData.seasons[seasonCurrentIndex].season : null),
            episode_pagging: props.pageInfoData.episodes ? props.pageInfoData.episode_pagging : (props.pageInfoData.seasons && props.pageInfoData.seasons[seasonCurrentIndex].episodes ? props.pageInfoData.seasons[seasonCurrentIndex].episode_pagging : false),
            nextTrailer:props.pageInfoData.nextTrailer,
            nextEpisode:props.pageInfoData.nextEpisode
        }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        } else if (nextProps.pageInfoData.movie != prevState.movie || nextProps.pageInfoData.trailer != prevState.trailer || nextProps.pageInfoData.episode != prevState.episode || (prevState.movie && nextProps.pageInfoData.movie.status != prevState.movie.status) || 
        (nextProps.pageInfoData.password != prevState.password) || nextProps.pageInfoData.adultMovie != prevState.adult) {
            let seasonCurrentIndex = nextProps.pageInfoData.seasonCurrentIndex ? nextProps.pageInfoData.seasonCurrentIndex : 0
           return {
                nextTrailer:nextProps.pageInfoData.nextTrailer,
                nextEpisode:nextProps.pageInfoData.nextEpisode,
                changeHeight:true,
                adminAdVideo:nextProps.pageInfoData.adminAdVideo,
                userAdVideo:nextProps.pageInfoData.userAdVideo,
                episode:nextProps.pageInfoData.episode,
                trailer:nextProps.pageInfoData.trailer,
                gateways:false,
                purchasePopup:false,
                contentType:nextProps.pageInfoData.contentType,
                movie:nextProps.pageInfoData.movie,
                seasons:nextProps.pageInfoData.seasons,
                clipsTrailers:nextProps.pageInfoData.clipsTrailers,
                needSubscription:nextProps.pageInfoData.needSubscription,
                plans:nextProps.pageInfoData.plans,
                tabType:nextProps.pageInfoData.tabType ? nextProps.pageInfoData.tabType : "episodes",
                relatedMovies:nextProps.pageInfoData.relatedMovies,
                movie_countries:nextProps.pageInfoData.movie ? nextProps.pageInfoData.movie.movie_countries : null,
                generes:nextProps.pageInfoData.movie ? nextProps.pageInfoData.movie.generes : null,
                castncrew:nextProps.pageInfoData.movie ? nextProps.pageInfoData.movie.castncrew : null,
                images:nextProps.pageInfoData.movie ? nextProps.pageInfoData.movie.images : null,
                reviews:nextProps.pageInfoData.reviews ? nextProps.pageInfoData.reviews : null,
                password: nextProps.pageInfoData.password,
                logout:false,
                changeHeight:true,
                adult: nextProps.pageInfoData.adultMovie,
                episodes: nextProps.pageInfoData.episodes ? nextProps.pageInfoData.episodes : (nextProps.pageInfoData.seasons && nextProps.pageInfoData.seasons[seasonCurrentIndex].episodes ? nextProps.pageInfoData.seasons[seasonCurrentIndex].episodes : null),
                episode_season: nextProps.pageInfoData.episode_season ? nextProps.pageInfoData.episode_season : (nextProps.pageInfoData.seasons && nextProps.pageInfoData.seasons[seasonCurrentIndex] ? nextProps.pageInfoData.seasons[seasonCurrentIndex].season : null),
                episode_pagging: nextProps.pageInfoData.episodes ? nextProps.pageInfoData.episode_pagging : (nextProps.pageInfoData.seasons && nextProps.pageInfoData.seasons[seasonCurrentIndex].episodes ? nextProps.pageInfoData.seasons[seasonCurrentIndex].episode_pagging : false),
    ...
    componentDidMount() {
        ...
        this.props.updatePlayerData([], [], null, "", "",this.props.pageInfoData.liveStreamingURL)
    ...
    pushTab = (type) => {
        ...
        let customParams = ""
        let customString = ""
        if(this.props.pageInfoData.seasonId){
          customParams += "/season/"+this.props.pageInfoData.seasonId
          customString += "&seasonId="+this.props.pageInfoData.seasonId
        }
        if(this.props.pageInfoData.episodeId){
          customParams += "/episode/"+this.props.pageInfoData.episodeId
          customString += "&episodeId="+this.props.pageInfoData.episodeId
        }
        if(this.props.pageInfoData.trailerId){
          customParams += "/trailer/"+this.props.pageInfoData.trailerId
          customString += "&trailerId="+this.props.pageInfoData.trailerId
        }
        if(!this.state.seasons && this.props.pageInfoData.play){
            customParams += "/play"
            customString += "&play=1"
        }
        Router.push(`/watch?videoId=${this.state.movie.custom_url}${customString}`, `/watch/${this.state.movie.custom_url}${customParams}?type=${type}`,{ shallow: true })
    }
    linkify(inputText) {
    ...
    checkPassword = model => {
        ...
        let url = '/movies/password/' + this.props.pageInfoData.videoId;
    ...
    watchNow = (e) => {
        ...
        if(this.state.episodes && this.state.episodes.length > 0){
            ...
            if(this.state.seasons){
                ...
                customString += "&seasonId="+this.state.episode_season                
                customParams += "/episode/"+episode.episode_number
                customString += "&episodeId="+episode.episode_number
                if(episode.trailerId){
                    customParams += "/trailer/"+episode.trailerId
                    customString += "&trailerId="+episode.trailerId
                }
                type = `?type=${this.state.tabType}`
                Router.push(`/watch?videoId=${this.state.movie.custom_url}${customString}`, `/watch/${this.state.movie.custom_url}${customParams}${type}`)
            }else{
                customParams += "/play"
                customString += "&play=1"
    ...
    videoEnd = (type) => {
        if(type == "episode" && this.state.nextEpisode){
            ...
            Router.push(`/watch?videoId=${this.state.movie.custom_url}&seasonId=${this.state.episode_season}&episodeId=${item.episode_number}`, `/watch/${this.state.movie.custom_url}/season/${this.state.episode_season}/episode/${item.episode_number}`)
        }else if(type == "trailer" && this.state.nextTrailer){
            let item = this.state.nextTrailer
            this.state.episode && this.state.seasons? 
                Router.push(`/watch?trailerId=${item.movie_video_id}&videoId=${this.state.movie.custom_url}&seasonId=${item.season}&episodeId=${item.episode_number}`, `/watch/${this.state.movie.custom_url}/season/${item.season}/episode/${item.episode_number}/trailer/${item.movie_video_id}`)
            :
            Router.push(`/watch?trailerId=${item.movie_video_id}&videoId=${this.state.movie.custom_url}`, `/watch/${this.state.movie.custom_url}/trailer/${item.movie_video_id}`)
        }
    }
    updatePlayCount = (id) => {
        if(typeof window == "undefined"){
    ...
    render(){
        ...
        if(imageURL){
            if(imageURL.indexOf("http://") == 0 || imageURL.indexOf("https://") == 0){
                ...
                imageURL = this.props.pageInfoData.imageSuffix+imageURL
            }
        }
        ...
        if(this.state.gateways){
            gatewaysHTML = <Gateways {...this.props} success={() => {
                ...
                setTimeout(() => {
                    ...
                    Router.push(`/watch?videoId=${this.state.movie.custom_url}${customString}`, `/watch/${this.state.movie.custom_url}${customParams}?type=${this.state.tabType}`)
                                                                ...
                                                                <React.Fragment>
                                                                {
                                                                    this.state.movie.approve == 1 ? 
                                                                        <React.Fragment>
                                                                            ...
                                                                            <SocialShare {...this.props} hideTitle={true} className="video_share" buttonHeightWidth="30" tags={this.state.movie.tags} url={`/watch/${this.state.movie.custom_url}`} title={this.state.movie.title} imageSuffix={this.props.pageInfoData.imageSuffix} media={this.state.movie.image} />
                                                                        ...
                                                                        <div className="dropdown TitleRightDropdown"><a href="#"
                                                                            ...
                                                                            <ul className="dropdown-menu dropdown-menu-right edit-options">
                                                                            {
                                                                                this.state.movie.canEdit ?
                                                                                    <li>
                                                                                        <Link href={`${this.state.contentType == "movies" ? "/create-movie" : "/create-series"}`} customParam={`movieId=${this.state.movie.custom_url}`} as={`${this.state.contentType == "movies" ? "/create-movie" : "/create-series"}/${this.state.movie.custom_url}`}>
                            ...
                            <div className="movie-player">
                                {
                                    ...
                                    :
                                    this.state.trailer.type == 'upload' && this.props.pageInfoData.appSettings['player_type'] == "element" ?
                                        <MediaElementPlayer {...this.props} updatePlayCount={this.updatePlayCount} getHeight={this.getHeight} playType={"trailer"} ended={this.videoEnd} height={"500px"} userAdVideo={this.state.userAdVideo} adminAdVideo={this.state.adminAdVideo} imageSuffix={this.props.pageInfoData.imageSuffix} video={this.props.pageInfoData.trailer} {...this.props.pageInfoData.trailer} />
                                    :
                                    this.state.trailer.type == 'upload' ?
                                        <Player {...this.props} updatePlayCount={this.updatePlayCount} getHeight={this.getHeight} playType={"trailer"} ended={this.videoEnd} height={"500px"} userAdVideo={this.state.userAdVideo} adminAdVideo={this.state.adminAdVideo} imageSuffix={this.props.pageInfoData.imageSuffix} video={this.props.pageInfoData.trailer} {...this.props.pageInfoData.trailer} />
                                    :
                                        <OutsidePlayer {...this.props} updatePlayCount={this.updatePlayCount}  ended={this.videoEnd} playType={"trailer"} height={"500px"} imageSuffix={this.props.pageInfoData.imageSuffix} video={this.props.pageInfoData.trailer}  {...this.props.pageInfoData.trailer} />
                                }
                            </div>
                        </div>
                        :
                                        ...
                                        <div className="movie-player">
                                            {
                                                this.state.episode.type == 'upload' ?
                                                    <Player {...this.props} updatePlayCount={this.updatePlayCount} getHeight={this.getHeight} playType={"episode"} ended={this.videoEnd} height={"500px"} userAdVideo={this.state.userAdVideo} adminAdVideo={this.state.adminAdVideo} imageSuffix={this.props.pageInfoData.imageSuffix} video={this.state.episode} {...this.state.episode} />
                                            :
                                                this.state.episode.code ?
                                                <OutsidePlayer {...this.props} updatePlayCount={this.updatePlayCount} playType={"episode"}  ended={this.videoEnd}  height={"500px"}  imageSuffix={this.props.pageInfoData.imageSuffix} video={this.state.episode}  {...this.state.episode} />
                                            :
                                                null
                                            }
                                        </div>
                                ...
                                <div className={`col-md-12`}> 
                                    <div className="details-tab">
                                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            {
                                                this.state.castncrew && this.state.castncrew.length > 0 && this.props.pageInfoData.appSettings['cast_crew_member'] == 1 ? 
                                            <li className="nav-item">
                                            ...
                                            {
                                                this.props.pageInfoData.appSettings[`${"movie_comment"}`] == 1 && this.state.movie.approve == 1 && (!this.state.episode || !this.state.seasons) ?
                                                    <li className="nav-item">
                                            ...
                                            }
                                            {
                                                this.props.pageInfoData.appSettings[`${"movie_comment"}`] == 1 && this.state.movie.approve == 1 && (!this.state.episode || !this.state.seasons) ?
                                                    <div className={`tab-pane fade${this.state.tabType == "comments" ? " active show" : ""}`} id="comments" role="tabpanel">
                                                        <div className="details-tab-box">
                                                            <Comment  {...this.props}  owner_id={this.state.movie.owner_id} hideTitle={true} appSettings={this.props.pageInfoData.appSettings} commentType="movie" type="movies" id={this.state.movie.movie_id} />
                                                        </div>
                                                    </div>
                                                    : null
                                            }
