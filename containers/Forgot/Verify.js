            ...
            <React.Fragment>
                    <div className="titleBarTop">
                        <div className="titleBarTopBg">
                            <img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageInfoData['subFolder']+"static/images/breadcumb-bg.jpg"} alt={this.props.t("Reset Password")} />
                        </div>
