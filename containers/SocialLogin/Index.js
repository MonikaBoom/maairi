...
class SocialLogin extends React.Component {
    ...
    render() {
        ...
        if( this.props.pageInfoData.appSettings['social_login_twitter'] != 1 && this.props.pageInfoData.appSettings['social_login_fb'] != 1  && this.props.pageInfoData.appSettings['social_login_google'] != 1 
