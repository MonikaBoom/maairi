    ...
    return (
        <React.Fragment>
           <li>
            ...
            <li>
                <Link customParam={`type=points`} as={`/dashboard/points`}>
                    <a className="dropdown-item iconmenu" style={{cursor:"pointer"}}>
            ...
            {
                props.pageInfoData.appSettings['video_watchlater'] == 1 ? 
            <li>
            ...
            {
                props.pageInfoData.appSettings["enable_movie"] == 1 && props.pageInfoData.appSettings['movie_watchlater'] == 1 ?
                <React.Fragment>
                   
                    <li>
                        <Link href="/dashboard" customParam={`type=movies&filter=watchlater`} as={`/dashboard/movies/watchlater`}>
                            <a className="dropdown-item iconmenu"  style={{cursor:"pointer"}}>
                    ...
                    <li>
                        <Link href="/dashboard" customParam={`type=series&filter=watchlater`} as={`/dashboard/series/watchlater`}>
                            <a className="dropdown-item iconmenu"  style={{cursor:"pointer"}}>
