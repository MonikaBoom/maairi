                                    ...
                                    <ul className="nav nav-tabs tabsLeft">

                                        {
                                            this.state.member.canEdit ?
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/general${user}`} onClick={this.changeType.bind(this, 'general')} className={this.state.type == "general" ? "active" : ""}>{Translate(this.props, "General")}</a>
                                                </li>
                                                : null
                                        }

                                        {
                                            this.state.member.canEdit ?
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/profile${user}`} onClick={this.changeType.bind(this, 'profile')} className={this.state.type == "profile" ? "active" : ""}>{Translate(this.props, "Profile")}</a>
                                                </li>
                                                : null
                                        }
                                        <li >
                                            <a href={`${this.props.pageInfoData.subFolder}dashboard/password${user}`} onClick={this.changeType.bind(this, 'password')} className={this.state.type == "password" ? "active" : ""}>{Translate(this.props, "Password")}</a>
                                        </li>
                                        {
                                            this.state.memberMonetization && isOwner ?
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/monetization${user}`} onClick={this.changeType.bind(this, 'monetization')} className={this.state.type == "monetization" ? "active" : ""}>{Translate(this.props, "Monetization")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            this.state.userShowBalance && isOwner ?
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/balance${user}`} onClick={this.changeType.bind(this, 'balance')} className={this.state.type == "balance" || this.state.type == "withdraw" ? "active" : ""}>{Translate(this.props, "Balance")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            this.props.pageInfoData.appSettings['enable_ponts'] == 1 && isOwner ?
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/points${user}`} onClick={this.changeType.bind(this, 'points')} className={this.state.type == "points" ? "active" : ""}>{Translate(this.props, "Points")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            this.state.member.verificationFunctionality && isOwner ?
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/verification${user}`} onClick={this.changeType.bind(this, 'verification')} className={this.state.type == "verification" ? "active" : ""}>{Translate(this.props, "Verification")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner ? 
                                        <li>
                                            <a href={`${this.props.pageInfoData.subFolder}dashboard/notifications${user}`} onClick={this.changeType.bind(this, 'notifications')} className={this.state.type == "notifications" ? "active" : ""} >{Translate(this.props, "Notifications Alert")}</a>
                                        </li>
                                        : null
                                        }
                                        {
                                            ...
                                            <li>
                                                <a href={`${this.props.pageInfoData.subFolder}dashboard/streamdata${user}`} onClick={this.changeType.bind(this, 'streamdata')} className={this.state.type == "streamdata" ? "active" : ""} >{Translate(this.props, "Default Stream Data")}</a>
                                            </li>
                                            : null
                                        }
                                        {
                                            ...
                                            <React.Fragment>
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/emails${user}`} onClick={this.changeType.bind(this, 'emails')} className={this.state.type == "emails" ? "active" : ""} >{Translate(this.props, "Emails Alert")}</a>
                                                </li>
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/videos${user}`} onClick={this.changeType.bind(this, 'videos')} className={this.state.type == "videos" ? "active" : ""} >{Translate(this.props, "Videos")}</a>
                                                </li>
                                            </React.Fragment>
                                        : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["movie.edit"] == 1 || this.props.pageData.levelPermissions["movie.edit"] == 2) && this.props.pageData.appSettings["enable_movie"] == 1 ?
                                                ...
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/movies${user}`} onClick={this.changeType.bind(this, 'movies')} className={this.state.type == "movies" ? "active" : ""}>{Translate(this.props, "Movies")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["movie.edit"] == 1 || this.props.pageData.levelPermissions["movie.edit"] == 2) && this.props.pageData.appSettings["enable_movie"] == 1 ?
                                                ...
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/series${user}`} onClick={this.changeType.bind(this, 'series')} className={this.state.type == "series" ? "active" : ""}>{Translate(this.props, "Series")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["channel.edit"] == 1 || this.props.pageData.levelPermissions["channel.edit"] == 2) && this.props.pageData.appSettings["enable_channel"] == 1 ?
                                                ...
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/channels${user}`} onClick={this.changeType.bind(this, 'channels')} className={this.state.type == "channels" ? "active" : ""}>{Translate(this.props, "Channels")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["blog.edit"] == 1 || this.props.pageData.levelPermissions["blog.edit"] == 2) && this.props.pageData.appSettings["enable_blog"] == 1 ?
                                                ...
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/blogs${user}`} onClick={this.changeType.bind(this, 'blogs')} className={this.state.type == "blogs" ? "active" : ""}>{Translate(this.props, "Blogs")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner ? 
                                                <li>
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/members${user}`} onClick={this.changeType.bind(this, 'members')} className={this.state.type == "members" ? "active" : ""}>{Translate(this.props, "Members")}</a>
                                                </li>
                                        : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["playlist.create"] == 1 || this.props.pageData.levelPermissions["playlist.edit"] == 2) && this.props.pageData.appSettings["enable_playlist"] == 1 ?
                                                ...
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/playlists${user}`} onClick={this.changeType.bind(this, 'playlists')} className={this.state.type == "playlists" ? "active" : ""}>{Translate(this.props, "Playlists")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["audio.create"] == 1 || this.props.pageData.levelPermissions["audio.edit"] == 2) && this.props.pageData.appSettings["enable_audio"] == 1 ?
                                                ...
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/audio${user}`} onClick={this.changeType.bind(this, 'audio')} className={this.state.type == "audio" ? "active" : ""}>{Translate(this.props, "Audio")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner ? 
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/purchases${user}`} onClick={this.changeType.bind(this, 'purchases')} className={this.state.type == "purchases" ? "active" : ""}>{Translate(this.props, "Purchases")}</a>
                                                </li>   
                                        : null
                                        }         
                                        {
                                            isOwner && this.state.userShowBalance ? 
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/earning${user}`} onClick={this.changeType.bind(this, 'earning')} className={this.state.type == "earning" ? "active" : ""}>{Translate(this.props, "Earning")}</a>
                                                </li>
                                                : null
                                        }
                                        {
                                            isOwner && (this.props.pageData.levelPermissions["member.ads"] == 1) && this.props.pageData.appSettings["enable_ads"] == 1 && (this.props.pageData.appSettings['video_ffmpeg_path'] || this.props.pageData.loggedInUserDetails.level_id == 1) ?
                                                ...
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/ads${user}`} onClick={this.changeType.bind(this, 'ads')} className={this.state.type == "ads" ? "active" : ""}>{Translate(this.props, "Advertisements")}</a>
                                                </li>
                                                : null
                                        }

                                        {
                                            this.state.member.canDelete ?
                                                <li >
                                                    <a href={`${this.props.pageInfoData.subFolder}dashboard/delete${user}`} onClick={this.changeType.bind(this, 'delete')} className={this.state.type == "delete" ? "active" : ""}>{Translate(this.props, "Delete Account")}</a>
                                                </li>
                                                : null
                                        }
                                    </ul>
