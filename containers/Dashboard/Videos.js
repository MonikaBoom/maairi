    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <BrowseVideos classNameP={"container"} {...this.props} canEdit={this.state.canEdit} canDelete={this.state.canDelete} videos={this.state.items} pagging={this.state.pagging} contentType={this.state.type} userContent={this.props.pageInfoData.user ? this.props.pageInfoData.user.user_id : 0} />
            </React.Fragment>
        )
    }
}
