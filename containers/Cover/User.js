...
class Cover extends Component {
    ...
    imageSize = (url) => {
        ...
        img.src = this.props.pageInfoData.imageSuffix+url;
        return promise;
    }
    ...
    openChat = () => {
        ...
        this.props.socket.emit('chatOpen', {user_id:this.props.pageInfoData.loggedInUserDetails.user_id,resource_id:this.state.item.user_id})
    }
    render() {
                                ...
                                <div className="userInfo-block-content">
                                    ...
                                    <div className="user_followed">
                                       <div className="follow-cnt">
                                           {
                                               this.props.pageInfoData.levelPermissions && parseInt(this.props.pageInfoData.levelPermissions["member.allow_messages"]) == 1 && (!this.props.pageInfoData.loggedInUserDetails || this.props.pageInfoData.loggedInUserDetails.user_id != this.state.item.user_id) ? 
