...
class Index extends Component {
    ...
    goLive = () => {
        let url = `${this.props.pageInfoData.siteURL}/live-streaming/${this.state.video.custom_url}`;
        window.open(url, '_blank').focus();
    }
    purchaseClicked = () => {
        let url = `${this.props.pageInfoData.siteURL}/watch/${this.state.video.custom_url}`;
        window.open(url, '_blank').focus();
    }
    render() {
