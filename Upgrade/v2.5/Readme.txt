PlayTubeVideo v2.5 Upgrade Documentation

Note: This update is just for who is using 2.4, if you're still using older verisons, Please Upgrade the script version by version.
